...
int main() //Funcion principal del porgrama, recoje toda la informácion de los pokemon, entrega al usuario 3 métodos de búsqueda diferentes y ejecuta la opción elegida.
{
    pkmn lista[p];
